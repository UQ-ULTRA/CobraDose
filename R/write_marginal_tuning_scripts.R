...
#' hyperparameters --- should re-run `write_marginal_tuning_scripts()` with
...
#' than the off-diagonal entries. If not, increase the first Dirichlet
#' parameter until this holds.
#'
#' @export
write_marginal_tuning_scripts <- function(
    output_dir = ".",
    n = 18,
    group_sizes = c(6, 4, 4, 4),
  ...
  marg_fun_code <- c(
    ...
    "library(CobraDose)",
    "",
    "# Auto-generated by CobraDose::write_marginal_tuning_scripts()",
    ...
    "CobraDose::register_bivar_copula_distribution()",
    "",
  ...
  sim_marg_code <- c(
    ...
    "  print(CobraDose::summarize_model_probs(sim_res[, 2:5]))",
    "}",
    "",
    "close(pb)",
