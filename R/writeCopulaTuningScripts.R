...
#' The default `prior_alpha_cop = c(1, 1, 1.05, 1)` was used in COBRA-DOSE
#' paper for a specific setting: total sample size 16, four dose groups
#' of sizes c(5, 4, 3, 4), gamma marginals, and the default
