...
#'           cop = 2, tau = 0.5)
#'
#' @return Bivariate observations corresponding to the same dose (each column corresponds to an endpoint)
#' @export
...
#' Generate a (hierarchical) sample across various doses
#'
#' This function takes in a sample size of `n` as well as inputs for the
...
dataGen <- function(n, gs, marg1, marg2, cop, hier = TRUE,
  ...
  return(list(Constants = constants, Responses = data, Parameters = params))
